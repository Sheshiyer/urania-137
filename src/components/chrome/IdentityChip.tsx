...
export function IdentityChip({ me }: { me: User | null }) {
  if (!me) return null
  return (
    <div className="hidden items-center gap-3 border-l border-gold/20 pl-3 sm:pl-5 md:flex">
      <span
      ...
      <a
        href="/api/logout"
        className="flex min-h-11 min-w-11 items-center justify-center gap-1.5 font-display text-[11px] uppercase tracking-[0.22em] text-silver transition-colors hover:text-gold"
