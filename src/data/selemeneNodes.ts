...
export const SELEMENE_NODES: StellarNode[] = [
  ...
  },
  {
    ...
    label: 'Union Mirror',
    epithet: 'The Union',
    description: 'Relational pattern field between two or more birth witnesses.',
    angle: 51.4,
    distance: 1,
    color: 'violet',
  ...
  },
  {
    ...
    label: 'Folio Archive',
    epithet: 'The Record',
    description: 'Previously generated readings and saved witnesses in one canonical Folio.',
    angle: 257,
    distance: 1,
    color: 'gold',
    subNodes: ['Saved', 'Favorites', 'Search', 'Mirror'],
    children: [
