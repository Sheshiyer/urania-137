...
export function TunnelExperience({ videoSrc, appHref }: TunnelExperienceProps) {
  ...
  return (
    <>
      ...
      <section
        ...
        aria-label="Urania 137 — enter the reading field"
      >
        <video
          ref={videoRef}
          className="tunnel__fallback-video"
          src={videoSrc}
          poster="/media/tunnel-poster.png"
          autoPlay
        ...
        <header className="cosmos-header">
          <a className="cosmos-brand" href="#experience" aria-label="Urania 137 home">
        ...
        <h1 className="cosmos-title" aria-label={HERO.title}>
          ...
          <span
            ...
            onPointerMove={updateTitleBlur}
          >
            <span className="cosmos-title__sharp">·</span>
            <span className="cosmos-title__blur-layer" aria-hidden="true">·</span>
          </span>
          <span
